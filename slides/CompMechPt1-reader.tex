...
\centering
\includegraphics[width=\linewidth,height=65mm,keepaspectratio]{pareto}
\end{minipage}\hfill
\begin{minipage}[t]{0.56\linewidth}
\centering
\includegraphics[width=\linewidth,height=65mm,keepaspectratio]{scope}
\end{minipage}
\end{center}
